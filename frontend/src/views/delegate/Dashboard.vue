  ...
  <div class="delegate-layout">
    <el-container>
      <el-aside v-if="!isFullscreen" width="200px" class="sidebar">
        ...
        <el-menu :default-active="activeMenu" router class="delegate-menu">
          ...
          <el-menu-item index="/delegate/meeting-files" :class="{ 'has-notification': notifications.meetingFiles }" @click="clearNotification('meetingFiles')">
            ...
            <span>会议文件</span>
            <span v-if="notifications.meetingFiles" class="notification-dot"></span>
          </el-menu-item>
        </el-menu>
      </el-aside>
      <el-container>
        <el-header>
          <div class="header-content">
            <div class="header-left">
              ...
              <span>代表端{{ delegationName ? ' - ' + delegationName : '' }}</span>
            </div>
...
.delegate-menu .el-menu-item {
  color: #bfcbd9;
}

.delegate-menu .el-menu-item:hover {
  background: #263445;
}

.delegate-menu .el-menu-item.is-active {
  color: #409eff;
}

/* 通知动画 */
.delegate-menu .el-menu-item.has-notification {
